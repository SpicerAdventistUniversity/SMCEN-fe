...
const courses = [
  ...
  },
  {
    ...
    credit: 2,
    semester: "II",
    mentor: "Pr. Vanlaltluaga Khuma",
  },
  {
    code: "RELB152",
    title: "Christian Beliefs II",
    credit: 2,
    semester: "II",
    mentor: "Mrs. Sharon Clinton",
  },
  {
    code: "FNCE252",
    title: "Church Stewardship & Finance",
    credit: 3,
    semester: "II",
    mentor: "Mr. Abhishek Lakra",
  },
  {
    code: "RELB292",
    title: "Apocalyptic Literature II",
    credit: 2,
    semester: "II",
    mentor: "Dr. Jesin Israel",
  },
...
const AdminDashboard = () => {
    ...
    const fetchUsers = async () => {
      try {
        ...
        const res = await axios.get(
          "https://smcen-be.onrender.com/api/admin/users",
          {
            headers: {
  ...
  const handleGradeChange = (courseCode, score) => {
    ...
    const { grade, pts } = getGradeAndPts(
      numericScore,
      courses.find((course) => course.code === courseCode)?.credit || 0,
    );
  ...
  const handleSaveGrades = async () => {
    try {
      ...
      await axios.put(
        `https://smcen-be.onrender.com/api/admin/update-grades/${editingUser._id}`,
        {
  ...
  const handleDownloadCertificates = () => {
    window.open(
      "https://smcen-be.onrender.com/api/admin/download-certificates",
      "_blank",
    );
  };
  ...
  const handleallsem1Certificates = () => {
    window.open(
      "https://smcen-be.onrender.com/api/admin/download-sem1",
      "_blank",
    );
  };
  const handleallsem2Certificates = () => {
    window.open(
      "https://smcen-be.onrender.com/api/admin/download-sem2",
      "_blank",
    );
  };
  ...
  const handleDownloadUser = async () => {
    try {
      const res = await axios.get(
        "https://smcen-be.onrender.com/api/users/export/csv",
        {
          responseType: "blob",
        },
      );
  ...
  const handleDownloadUserSem2 = async () => {
    try {
      const res = await axios.get(
        "https://smcen-be.onrender.com/api/users/export/csv-sem2",
        {
          responseType: "blob",
        },
      );
        ...
        <Card className="p-4 shadow">
          ...
          {loading ? (
            ...
            <div>
                    ...
                    <tr key={course.code}>
                      ...
                      <td>
                        <Form.Control
                          ...
                          max="100"
                          value={
                            grades[course.code]?.score === ""
                              ? ""
                              : grades[course.code]?.score || ""
                          }
                          onChange={(e) =>
                            handleGradeChange(course.code, e.target.value)
                          }
                        />
                      </td>
              ...
              <Button variant="success" onClick={handleSaveGrades}>
                Save Grades
              </Button>
              <Button
                variant="secondary"
            ...
            <>
              <div className="d-flex justify-content-center gap-4 mb-4">
                ...
                <Button
                  ...
                  size="lg"
                  className="shadow"
                  onClick={handleallsem1Certificates}
                >
                ...
                <Button
                  ...
                  size="lg"
                  className="shadow"
                  onClick={handleallsem2Certificates}
                >
                ...
                <Button
                  ...
                  size="lg"
                  className="shadow"
                  onClick={handleDownloadUserSem2}
                >
